...
int game_menu(GAME *game)
{
    ...
    SDL_Surface *options[4]= {NULL}; // Réduit à 4 pour supprimer les options plein écran
    ...
    SDL_Rect positionoptions, positionoption2;
    ...
    musique = Mix_LoadMUS("DATA/SFX/menu.ogg");
    ...
    // Menu options (seulement pour la musique)
    options_back = IMG_Load("DATA/GFX/menu/options/Options.png");
    options[0] = IMG_Load("DATA/GFX/menu/options/MUSICONa.png");
    options[1] = IMG_Load("DATA/GFX/menu/options/MUSICOFFa.png");
    options[2] = IMG_Load("DATA/GFX/menu/options/MUSICONb.png");
    options[3] = IMG_Load("DATA/GFX/menu/options/MUSICOFFb.png");
    ...
    while (menu.continuer)
    {
        ...
        // Menu options (musique uniquement)
        if (menu.SHOW_OPTION)
        {
        ...
        if (SDL_PollEvent(&event)==1)
        {
            ...
            else if (event.type == SDL_KEYDOWN)
            {
                if(!fix)
                {
                    ...
                    case SDLK_DOWN:
                        ...
                        if (menu.SHOW_OPTION)
                        {
                            if (menu.opt2_select==0) menu.opt2_select=2;
                            if (menu.opt2_select==1) menu.opt2_select=3;
                            fix=1;
                        }
                        break;
                    case SDLK_UP:
                        ...
                        if (menu.SHOW_OPTION)
                        {
                            if (menu.opt2_select==2) menu.opt2_select=0;
                            if (menu.opt2_select==3) menu.opt2_select=1;
                            fix=1;
                        }
                        break;
                    case SDLK_RIGHT:
            ...
            if (event.type == SDL_MOUSEMOTION && !menu.SHOW_OPTION && !menu.SHOW_EXIT)
            {
                ...
                {
                    if(!fix_son) Mix_PlayChannel(1, son, 0);
                    menu.etat = 1;
                    fix_son=1;
                }
